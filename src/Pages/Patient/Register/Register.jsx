...
export default function PatientRegister() {
	...
	const errorhandling = () => {
		...
		const nic = document.getElementById("floating_NIC");
		const dob = document.getElementById("floating_birthday");
		const username = document.getElementById("floating_username");
	...
	return (
		<div className="bg-main-blue w-[100%] h-full">
			...
			<div className="ml-20">
				...
				<form className="bg-white w-[65%] h-auto p-14 rounded-xl">
					<p
				...
				<img
					src={RegisterImage}
					alt="image"
					className="w-[550px] absolute left-[1100px] top-[450px]"
				/>
			</div>
			<Footer />
		</div>
